...
public class TacosAdapter extends BaseAdapter {
    private final Context context;
    private final List<ItemTacos> items;
    private final FragmentManager fragmentManager;

    public TacosAdapter(Context context, List<ItemTacos> items, FragmentManager fragmentManager) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemTacos currentItem = (ItemTacos) getItem(position);
