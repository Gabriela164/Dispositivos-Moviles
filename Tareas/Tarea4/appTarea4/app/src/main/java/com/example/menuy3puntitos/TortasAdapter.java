...
public class TortasAdapter extends BaseAdapter {
    private final Context context;
    private final List<ItemTortas> items;
    private final FragmentManager fragmentManager;

    public TortasAdapter(Context context, List<ItemTortas> items, FragmentManager fragmentManager) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemTortas currentItem = (ItemTortas) getItem(position);
