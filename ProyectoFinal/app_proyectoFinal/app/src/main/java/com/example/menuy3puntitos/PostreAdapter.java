...
public class PostreAdapter extends BaseAdapter {
    ...
    private final List<ItemPostre> items;
    private final FragmentManager fragmentManager;

    public PostreAdapter(Context context, List<ItemPostre> items, FragmentManager fragmentManager) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemPostre currentItem = (ItemPostre) getItem(position);
